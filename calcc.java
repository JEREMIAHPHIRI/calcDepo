//000764-jeremiah-phiri-ARTIFICIAL INTELLIGENCE CALCULATOR ASSIGNMENT WITH FOCUS ON MEMORY RECALL. 2018- CAVENNDISH UNIVERSITY
package main;
		...
		if (s.equals("x^x")) {
			if (tfield.getText().equals("")) {
				tfield.setText("");
                                ...
                                int b=Integer.parseInt(tfield.getText());
				a = Math.pow(Double.parseDouble(tfield.getText()),b);
				tfield.setText("");
				tfield.setText(tfield.getText() + a);
			}
		}
